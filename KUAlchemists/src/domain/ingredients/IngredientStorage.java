...
public class IngredientStorage {
	...
	private static final Ingredient[] allIngredientCardsArray =
		...
		new Ingredient(5,"Goldhorn's Tooth", "src/images/images-icons/ingredient5.jpg",  new Alchemical (new AlchemyMarker ("-", "red", "S"), new AlchemyMarker ("+", "green", "S"), new AlchemyMarker ("-", "blue", "L"), new ImageIcon())),
